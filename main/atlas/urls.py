...
urlpatterns = [
    ...
    url(r'^update_bsr_name/(?P<bsr_id>.*)/$', views.update_bsr_name, name='update_bsr_name'),
    url(r'^update_bsr_gen_info/(?P<bsr_id>.*)/$', views.update_bsr_gen_info, name='update_bsr_gen_info'),
    url(r'^update_opp_name/(?P<opp_id>.*)/$', views.update_opp_name, name='update_opp_name'),
    url(r'^update_opp_status/(?P<opp_id>.*)/$', views.update_opp_status, name='update_opp_status'),
    ...
    url(r'^update_notes/(?P<bsr_id>.*)/$', views.update_notes, name='update_notes'),
    ...
    url(r'^load_p_forms/(?P<bsr_id>.*)/$', views.load_p_forms, name='load_p_forms'),
    url(r'^load_util_forms/(?P<bsr_id>.*)/$', views.load_util_forms, name='load_util_forms'),
    url(r'^load_lf_forms/(?P<bsr_id>.*)/$', views.load_lf_forms, name='load_lf_forms'),
    url(r'^load_ra_forms/(?P<bsr_id>.*)/$', views.load_ra_forms, name='load_ra_forms'),
]
